    ...
    const renderTurnstile = () => {
      if (windowAny.turnstile && containerRef.current) {
        windowAny.turnstile.render(containerRef.current, {
          sitekey: process.env.NODE_ENV === 'development' ? '1x00000000000000000000AA' : process.env.NEXT_PUBLIC_TURNSTILE_KEY || "0x4AAAAAACLyd4XoDMS56kOLRKOQfMRUUJU",
          size: process.env.NODE_ENV === 'development' ? 'compact' : 'invisible',
